    ...
    <div className="flex min-h-screen">
      ...
      <aside className="w-64 bg-gradient-to-b from-blue-900 to-blue-800 text-white p-4 sticky top-0 h-screen overflow-y-auto">
        ...
        <nav className="space-y-2">
          ...
          <a href="/dashboard/orders" className="block px-4 py-2 rounded hover:bg-gray-700">
            {t('orders')}
          </a>
          
          {/* Staff only */}
          <a href="/dashboard/prescriptions" className="block px-4 py-2 rounded hover:bg-gray-700">
            {t('prescriptions')}
          </a>
          <a href="/dashboard/customers" className="block px-4 py-2 rounded hover:bg-gray-700">
            {t('customers')}
          </a>
          <a href="/dashboard/returns" className="block px-4 py-2 rounded hover:bg-gray-700">
            {t('returns')}
          </a>
          
          {/* Operations only */}
          <a href="/dashboard/inventory" className="block px-4 py-2 rounded hover:bg-gray-700">
            {t('inventory')}
          </a>
          
          {/* Manager + Admin */}
          <a href="/dashboard/products" className="block px-4 py-2 rounded hover:bg-gray-700">
            {t('products')}
          </a>
          <a href="/dashboard/users" className="block px-4 py-2 rounded hover:bg-gray-700">
            {t('users')}
          </a>
          <a href="/dashboard/reports" className="block px-4 py-2 rounded hover:bg-gray-700">
            {t('reports')}
          </a>
