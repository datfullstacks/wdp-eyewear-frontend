...
const Refunds = ({ scope = 'sale' }: RefundsProps) => {
  ...
  const afterSalesLabel =
    scope === 'operation' ? t('warrantyQueueLabel') : t('afterSalesLabel');
      ...
      <div className="space-y-6 p-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-64">
                ...
                <DropdownMenuLabel>{t('methodLabel')}</DropdownMenuLabel>
                <DropdownMenuRadioGroup
                  value={methodFilter}
        ...
        {scope === 'sale' && (
          <div className="flex flex-wrap gap-2">
            {[
              { value: 'needs_action', label: t('queueNeedsAction') },
              { value: 'waiting_customer', label: t('queueWaiting') },
              { value: 'tracking', label: t('queueTracking') },
            ].map((option) => {
