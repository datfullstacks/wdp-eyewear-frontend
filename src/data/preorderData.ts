...
export const mockPreorderOrders: PreorderOrder[] = [
  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        name: 'Tròng phân cực',
        variant: 'Gray',
        supplier: 'Lens Partner',
        warehouseLocation: 'KHO-HCM-LENS-C1',
        quantity: 2,
        batchCode: null,
  ...
  },
  {
    ...
    storeId: 'store-hcm-bt',
    storeName: 'Branch Bình Thạnh',
    ...
    products: [
      {
        ...
        name: 'Gucci GG0036S',
        variant: 'Black / Gold',
        supplier: 'Luxury Eyewear',
        warehouseLocation: 'KHO-HCM-LUX-D3',
        quantity: 1,
        batchCode: 'BATCH-2024-001',
        batchExpectedDate: '2024-01-20',
        status: 'in_transit',
  ...
  },
  {
    ...
    storeId: 'store-hcm-q10',
    storeName: 'Branch Q10',
    ...
    products: [
      {
        ...
        variant: 'Havana',
        supplier: 'Tom Ford Distributor',
        warehouseLocation: 'KHO-HCM-TF-A4',
        quantity: 1,
    ...
    products: [
      {
        ...
        variant: 'Tortoise',
        supplier: 'Persol VN',
        warehouseLocation: 'KHO-HCM-PER-B1',
        quantity: 1,
        batchCode: 'BATCH-2024-002',
        batchExpectedDate: '2024-01-18',
        status: 'arrived',
